    ...
    public class ERSCreateDatabaseIfNotExists : CreateDatabaseIfNotExists<ERServiceDbContext>
    {
        protected override void Seed(ERServiceDbContext context)
        {
            ...
            context.AclVerbs.AddOrUpdate(a => a.Name,
                new AclVerb() { Id = new Guid("{60FF3DB2-DBB4-4B4D-90D0-DFCE413E1935}"), Name = "Dostęp do konfiguracji aplikacji", DefaultValue = 0 },
                new AclVerb() { Id = new Guid("{D060FFBD-4188-443E-862D-8A637CC395D3}"), Name = "Dostęp do konfiguracji wydruków", DefaultValue = 0 },
                new AclVerb() { Id = new Guid("{C463591E-C323-4DC8-8A2D-F79EEF7D1624}"), Name = "Dostęp do konfiguracji numeracji", DefaultValue = 0 },
                new AclVerb() { Id = new Guid("{C463591E-C323-4DC8-8A2D-F79EEF7D1624}"), Name = "Zarządzanie użytkownikami", DefaultValue = 0 },
