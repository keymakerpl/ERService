...
namespace Smith.WPF.HtmlEditor.Demo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        void InitEvents()
        {
            ...
            GetHtmlButton.Click += new RoutedEventHandler(ConvertToPdf);
        ...
        void ConvertToPdf(object sender, RoutedEventArgs e)
        {
            //var orderNumber = "0107/2019";
            //var result = Editor.ContentHtml.Replace("{numer}", orderNumber);
            //PdfDocument pdf = PdfGenerator.GeneratePdf(result, PageSize.A4);
